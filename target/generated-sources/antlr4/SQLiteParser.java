...
public class SQLiteParser extends Parser {
	...
	public final Compound_select_stmtContext compound_select_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==K_WITH) {
				{
				setState(293); with_clause();
				}
			}

			setState(296); select_core();
			setState(306); 
			_errHandler.sync(this);
			_la = _input.LA(1);
			do {
				...
				case K_UNION:
					{
					setState(297); match(K_UNION);
					setState(299);
					_la = _input.LA(1);
					if (_la==K_ALL) {
						{
						setState(298); match(K_ALL);
						}
					}
				...
				case K_INTERSECT:
					{
					setState(301); match(K_INTERSECT);
					}
					break;
				case K_EXCEPT:
					{
					setState(302); match(K_EXCEPT);
					}
					break;
				default:
					throw new NoViableAltException(this);
			...
			if (_la==K_ORDER) {
				{
				setState(310); match(K_ORDER);
				setState(311); match(K_BY);
				setState(312); ordering_term();
				setState(317);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
	...
	public final Create_index_stmtContext create_index_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(330); match(K_CREATE);
			setState(332);
			_la = _input.LA(1);
			if (_la==K_UNIQUE) {
				{
				setState(331); match(K_UNIQUE);
				}
			}

			setState(334); match(K_INDEX);
			setState(338);
			switch ( getInterpreter().adaptivePredict(_input,28,_ctx) ) {
			case 1:
				{
				setState(335); match(K_IF);
				setState(336); match(K_NOT);
				setState(337); match(K_EXISTS);
				}
				break;
			}
			setState(343);
			...
			case 1:
				{
				setState(340); database_name();
				setState(341); match(DOT);
				}
				break;
			}
			setState(345); index_name();
			setState(346); match(K_ON);
			setState(347); table_name();
			setState(348); match(OPEN_PAR);
			setState(349); indexed_column();
			setState(354);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
	...
	public final Create_table_stmtContext create_table_stmt() throws RecognitionException {
		...
		try {
			...
			setState(366); match(K_TABLE);
			setState(370);
			switch ( getInterpreter().adaptivePredict(_input,33,_ctx) ) {
			case 1:
				{
				setState(367); match(K_IF);
				setState(368); match(K_NOT);
				setState(369); match(K_EXISTS);
				}
				break;
			}
			setState(375);
			...
			case 1:
				{
				setState(372); database_name();
				setState(373); match(DOT);
				}
				break;
			}
			setState(377); table_name();
			setState(401);
			switch (_input.LA(1)) {
			case OPEN_PAR:
				{
				setState(378); match(OPEN_PAR);
				setState(379); column_def();
				setState(384);
				_errHandler.sync(this);
			...
			case K_AS:
				{
				setState(399); match(K_AS);
				setState(400); select_stmt();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Create_trigger_stmtContext create_trigger_stmt() throws RecognitionException {
		...
		try {
			...
			setState(407); match(K_TRIGGER);
			setState(411);
			switch ( getInterpreter().adaptivePredict(_input,40,_ctx) ) {
			case 1:
				{
				setState(408); match(K_IF);
				setState(409); match(K_NOT);
				setState(410); match(K_EXISTS);
				}
				break;
			}
			setState(416);
			...
			case 1:
				{
				setState(413); database_name();
				setState(414); match(DOT);
				}
				break;
			}
			setState(418); trigger_name();
			setState(423);
			switch (_input.LA(1)) {
			case K_BEFORE:
				{
				setState(419); match(K_BEFORE);
				}
				break;
			case K_AFTER:
				{
				setState(420); match(K_AFTER);
				}
				break;
			case K_INSTEAD:
				{
				setState(421); match(K_INSTEAD);
				setState(422); match(K_OF);
				}
				break;
			case K_DELETE:
			case K_INSERT:
			...
			case K_DELETE:
				{
				setState(425); match(K_DELETE);
				}
				break;
			case K_INSERT:
				{
				setState(426); match(K_INSERT);
				}
				break;
			case K_UPDATE:
				{
				setState(427); match(K_UPDATE);
				setState(437);
				_la = _input.LA(1);
				if (_la==K_OF) {
					{
					setState(428); match(K_OF);
					setState(429); column_name();
					setState(434);
					_errHandler.sync(this);
					_la = _input.LA(1);
					while (_la==COMMA) {
			...
			setState(441); match(K_ON);
			setState(445);
			switch ( getInterpreter().adaptivePredict(_input,46,_ctx) ) {
			case 1:
				{
				setState(442); database_name();
				setState(443); match(DOT);
				}
				break;
			}
			setState(447); table_name();
			setState(451);
			_la = _input.LA(1);
			if (_la==K_FOR) {
				{
				setState(448); match(K_FOR);
				setState(449); match(K_EACH);
				setState(450); match(K_ROW);
				}
			}
			...
			if (_la==K_WHEN) {
				{
				setState(453); match(K_WHEN);
				setState(454); expr(0);
				}
			}

			setState(457); match(K_BEGIN);
			setState(466); 
			_errHandler.sync(this);
			_la = _input.LA(1);
			do {
				...
				case 1:
					{
					setState(458); update_stmt();
					}
					break;
				case 2:
					{
					setState(459); insert_stmt();
					}
					break;
				case 3:
					{
					setState(460); delete_stmt();
					}
					break;
				case 4:
					{
					setState(461); select_stmt();
					}
					break;
				}
				setState(464); match(SCOL);
				}
				}
				setState(468); 
				_errHandler.sync(this);
	...
	public final Create_view_stmtContext create_view_stmt() throws RecognitionException {
		...
		try {
			...
			setState(487); view_name();
			setState(488); match(K_AS);
			setState(489); select_stmt();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Create_virtual_table_stmtContext create_virtual_table_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(491); match(K_CREATE);
			setState(492); match(K_VIRTUAL);
			setState(493); match(K_TABLE);
			setState(497);
			switch ( getInterpreter().adaptivePredict(_input,54,_ctx) ) {
			case 1:
				{
				setState(494); match(K_IF);
				setState(495); match(K_NOT);
				setState(496); match(K_EXISTS);
				}
				break;
			}
			setState(502);
			...
			case 1:
				{
				setState(499); database_name();
				setState(500); match(DOT);
				}
				break;
			}
			setState(504); table_name();
			setState(505); match(K_USING);
			setState(506); module_name();
			setState(518);
			_la = _input.LA(1);
			if (_la==OPEN_PAR) {
				{
				setState(507); match(OPEN_PAR);
				setState(508); module_argument();
				setState(513);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
	...
	public final Delete_stmtContext delete_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==K_WITH) {
				{
				setState(520); with_clause();
				}
			}

			setState(523); match(K_DELETE);
			setState(524); match(K_FROM);
			setState(525); qualified_table_name();
			setState(528);
			_la = _input.LA(1);
			if (_la==K_WHERE) {
				{
				setState(526); match(K_WHERE);
				setState(527); expr(0);
				}
			}
	...
	public final Delete_stmt_limitedContext delete_stmt_limited() throws RecognitionException {
		...
		try {
			...
			if (_la==K_WITH) {
				{
				setState(530); with_clause();
				}
			}

			setState(533); match(K_DELETE);
			setState(534); match(K_FROM);
			setState(535); qualified_table_name();
			setState(538);
			_la = _input.LA(1);
			if (_la==K_WHERE) {
				{
				setState(536); match(K_WHERE);
				setState(537); expr(0);
				}
			}
			...
			if (_la==K_LIMIT || _la==K_ORDER) {
				...
				if (_la==K_ORDER) {
					{
					setState(540); match(K_ORDER);
					setState(541); match(K_BY);
					setState(542); ordering_term();
					setState(547);
					_errHandler.sync(this);
					_la = _input.LA(1);
					while (_la==COMMA) {
	...
	public final Detach_stmtContext detach_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(560); match(K_DETACH);
			setState(562);
			switch ( getInterpreter().adaptivePredict(_input,66,_ctx) ) {
			case 1:
				{
				setState(561); match(K_DATABASE);
				}
				break;
			}
			setState(564); database_name();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Drop_trigger_stmtContext drop_trigger_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(592); match(K_DROP);
			setState(593); match(K_TRIGGER);
			setState(596);
			switch ( getInterpreter().adaptivePredict(_input,71,_ctx) ) {
			case 1:
				{
				setState(594); match(K_IF);
				setState(595); match(K_EXISTS);
				}
				break;
			}
			setState(601);
			...
			case 1:
				{
				setState(598); database_name();
				setState(599); match(DOT);
				}
				break;
			}
			setState(603); trigger_name();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Drop_view_stmtContext drop_view_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(605); match(K_DROP);
			setState(606); match(K_VIEW);
			setState(609);
			switch ( getInterpreter().adaptivePredict(_input,73,_ctx) ) {
			case 1:
				{
				setState(607); match(K_IF);
				setState(608); match(K_EXISTS);
				}
				break;
			}
			setState(614);
			...
			case 1:
				{
				setState(611); database_name();
				setState(612); match(DOT);
				}
				break;
			}
			setState(616); view_name();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Factored_select_stmtContext factored_select_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==K_WITH) {
				{
				setState(618); with_clause();
				}
			}

			setState(621); select_core();
			setState(627);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==K_EXCEPT || _la==K_INTERSECT || _la==K_UNION) {
				{
				{
				setState(622); compound_operator();
				setState(623); select_core();
				}
				}
				setState(629);
				_errHandler.sync(this);
			...
			if (_la==K_ORDER) {
				{
				setState(630); match(K_ORDER);
				setState(631); match(K_BY);
				setState(632); ordering_term();
				setState(637);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
	...
	public final Insert_stmtContext insert_stmt() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(653); match(K_INSERT);
				}
				break;
			case 2:
				{
				setState(654); match(K_REPLACE);
				}
				break;
			case 3:
				{
				setState(655); match(K_INSERT);
				setState(656); match(K_OR);
				setState(657); match(K_REPLACE);
				}
				break;
			case 4:
				{
				setState(658); match(K_INSERT);
				setState(659); match(K_OR);
				setState(660); match(K_ROLLBACK);
				}
				break;
			case 5:
				{
				setState(661); match(K_INSERT);
				setState(662); match(K_OR);
				setState(663); match(K_ABORT);
				}
				break;
			case 6:
				{
				setState(664); match(K_INSERT);
				setState(665); match(K_OR);
				setState(666); match(K_FAIL);
				}
				break;
			case 7:
				{
				setState(667); match(K_INSERT);
				setState(668); match(K_OR);
				setState(669); match(K_IGNORE);
				}
				break;
			}
			setState(672); match(K_INTO);
			setState(676);
			...
			setState(678); table_name();
			setState(690);
			_la = _input.LA(1);
			if (_la==OPEN_PAR) {
				{
				setState(679); match(OPEN_PAR);
				setState(680); column_name();
				setState(685);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
			...
			case 2:
				{
				setState(720); select_stmt();
				}
				break;
			case 3:
				{
				setState(721); match(K_DEFAULT);
				setState(722); match(K_VALUES);
				}
				break;
			}
			}
	...
	public final Pragma_stmtContext pragma_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(725); match(K_PRAGMA);
			setState(729);
			switch ( getInterpreter().adaptivePredict(_input,90,_ctx) ) {
			case 1:
				{
				setState(726); database_name();
				setState(727); match(DOT);
				}
				break;
			}
			setState(731); pragma_name();
			setState(738);
			switch (_input.LA(1)) {
			case ASSIGN:
				{
				setState(732); match(ASSIGN);
				setState(733); pragma_value();
				}
				break;
			case OPEN_PAR:
				{
				setState(734); match(OPEN_PAR);
				setState(735); pragma_value();
				setState(736); match(CLOSE_PAR);
				}
				break;
			case EOF:
			case SCOL:
	...
	public final Reindex_stmtContext reindex_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(740); match(K_REINDEX);
			setState(751);
			switch ( getInterpreter().adaptivePredict(_input,94,_ctx) ) {
			case 1:
				{
				setState(741); collation_name();
				}
				break;
			case 2:
				{
	...
	public final Release_stmtContext release_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(753); match(K_RELEASE);
			setState(755);
			switch ( getInterpreter().adaptivePredict(_input,95,_ctx) ) {
			case 1:
				{
				setState(754); match(K_SAVEPOINT);
				}
				break;
			}
			setState(757); savepoint_name();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Rollback_stmtContext rollback_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(759); match(K_ROLLBACK);
			setState(764);
			_la = _input.LA(1);
			if (_la==K_TRANSACTION) {
				{
				setState(760); match(K_TRANSACTION);
				setState(762);
				switch ( getInterpreter().adaptivePredict(_input,96,_ctx) ) {
				case 1:
					{
					setState(761); transaction_name();
					}
					break;
				}
				}
			...
			if (_la==K_TO) {
				{
				setState(766); match(K_TO);
				setState(768);
				switch ( getInterpreter().adaptivePredict(_input,98,_ctx) ) {
				case 1:
					{
					setState(767); match(K_SAVEPOINT);
					}
					break;
				}
				setState(770); savepoint_name();
				}
			}
	...
	public final Savepoint_stmtContext savepoint_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(773); match(K_SAVEPOINT);
	...
	public final Simple_select_stmtContext simple_select_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==K_WITH) {
				{
				setState(776); with_clause();
				}
			}

			setState(779); select_core();
			setState(790);
			_la = _input.LA(1);
			if (_la==K_ORDER) {
				{
				setState(780); match(K_ORDER);
				setState(781); match(K_BY);
				setState(782); ordering_term();
				setState(787);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
	...
	public final Select_stmtContext select_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==K_WITH) {
				{
				setState(800); with_clause();
				}
			}

			setState(803); select_or_values();
			setState(809);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==K_EXCEPT || _la==K_INTERSECT || _la==K_UNION) {
				{
				{
				setState(804); compound_operator();
				setState(805); select_or_values();
				}
				}
				setState(811);
				_errHandler.sync(this);
			...
			if (_la==K_ORDER) {
				{
				setState(812); match(K_ORDER);
				setState(813); match(K_BY);
				setState(814); ordering_term();
				setState(819);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
	...
	public final Select_or_valuesContext select_or_values() throws RecognitionException {
		...
		try {
			...
			case K_SELECT:
				...
				if (_la==K_FROM) {
					{
					setState(844); match(K_FROM);
					setState(854);
					switch ( getInterpreter().adaptivePredict(_input,114,_ctx) ) {
					case 1:
						{
						setState(845); table_or_subquery();
						setState(850);
						_errHandler.sync(this);
						_la = _input.LA(1);
						while (_la==COMMA) {
							...
							setState(847); table_or_subquery();
							}
							}
							setState(852);
							_errHandler.sync(this);
				...
				if (_la==K_GROUP) {
					{
					setState(862); match(K_GROUP);
					setState(863); match(K_BY);
					setState(864); expr(0);
					setState(869);
					_errHandler.sync(this);
					_la = _input.LA(1);
			...
			case K_VALUES:
				...
				{
				setState(878); match(K_VALUES);
				setState(879); match(OPEN_PAR);
				setState(880); expr(0);
				setState(885);
				_errHandler.sync(this);
				_la = _input.LA(1);
	...
	public final Update_stmtContext update_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==K_WITH) {
				{
				setState(908); with_clause();
				}
			}

			setState(911); match(K_UPDATE);
			setState(922);
			switch ( getInterpreter().adaptivePredict(_input,125,_ctx) ) {
			case 1:
				{
				setState(912); match(K_OR);
				setState(913); match(K_ROLLBACK);
				}
				break;
			case 2:
				{
				setState(914); match(K_OR);
				setState(915); match(K_ABORT);
				}
				break;
			case 3:
				{
				setState(916); match(K_OR);
				setState(917); match(K_REPLACE);
				}
				break;
			case 4:
				{
				setState(918); match(K_OR);
				setState(919); match(K_FAIL);
				}
				break;
			case 5:
				{
				setState(920); match(K_OR);
				setState(921); match(K_IGNORE);
				}
				break;
			}
			setState(924); qualified_table_name();
			setState(925); match(K_SET);
			setState(926); column_name();
			setState(927); match(ASSIGN);
			setState(928); expr(0);
			setState(936);
			_errHandler.sync(this);
			_la = _input.LA(1);
	...
	public final Update_stmt_limitedContext update_stmt_limited() throws RecognitionException {
		...
		try {
			...
			if (_la==K_WITH) {
				{
				setState(943); with_clause();
				}
			}

			setState(946); match(K_UPDATE);
			setState(957);
			switch ( getInterpreter().adaptivePredict(_input,129,_ctx) ) {
			case 1:
				{
				setState(947); match(K_OR);
				setState(948); match(K_ROLLBACK);
				}
				break;
			case 2:
				{
				setState(949); match(K_OR);
				setState(950); match(K_ABORT);
				}
				break;
			case 3:
				{
				setState(951); match(K_OR);
				setState(952); match(K_REPLACE);
				}
				break;
			case 4:
				{
				setState(953); match(K_OR);
				setState(954); match(K_FAIL);
				}
				break;
			case 5:
				{
				setState(955); match(K_OR);
				setState(956); match(K_IGNORE);
				}
				break;
			}
			setState(959); qualified_table_name();
			setState(960); match(K_SET);
			setState(961); column_name();
			setState(962); match(ASSIGN);
			setState(963); expr(0);
			setState(971);
			_errHandler.sync(this);
			_la = _input.LA(1);
			...
			if (_la==K_LIMIT || _la==K_ORDER) {
				...
				if (_la==K_ORDER) {
					{
					setState(978); match(K_ORDER);
					setState(979); match(K_BY);
					setState(980); ordering_term();
					setState(985);
					_errHandler.sync(this);
					_la = _input.LA(1);
					while (_la==COMMA) {
	...
	public final Column_defContext column_def() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1000); column_name();
			setState(1002);
			switch ( getInterpreter().adaptivePredict(_input,136,_ctx) ) {
			case 1:
				{
				setState(1001); type_name();
				}
				break;
			}
			setState(1007);
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << K_CHECK) | (1L << K_COLLATE) | (1L << K_CONSTRAINT) | (1L << K_DEFAULT))) != 0) || ((((_la - 102)) & ~0x3f) == 0 && ((1L << (_la - 102)) & ((1L << (K_NOT - 102)) | (1L << (K_NULL - 102)) | (1L << (K_PRIMARY - 102)) | (1L << (K_REFERENCES - 102)) | (1L << (K_UNIQUE - 102)))) != 0)) {
				{
				{
				setState(1004); column_constraint();
				}
				}
				setState(1009);
				_errHandler.sync(this);
	...
	public final Type_nameContext type_name() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(1015); match(OPEN_PAR);
				setState(1016); signed_number();
				setState(1017); match(CLOSE_PAR);
				}
				break;
			case 2:
				{
				...
				setState(1022); signed_number();
				setState(1023); match(CLOSE_PAR);
				}
				break;
			}
			}
	...
	public final Column_constraintContext column_constraint() throws RecognitionException {
		...
		try {
			...
			if (_la==K_CONSTRAINT) {
				{
				setState(1027); match(K_CONSTRAINT);
				setState(1028); name();
				}
			}
			...
			case K_PRIMARY:
				{
				setState(1031); match(K_PRIMARY);
				setState(1032); match(K_KEY);
				setState(1034);
				_la = _input.LA(1);
				...
				setState(1036); conflict_clause();
				setState(1038);
				_la = _input.LA(1);
				if (_la==K_AUTOINCREMENT) {
					{
					setState(1037); match(K_AUTOINCREMENT);
					}
				}
			...
			case K_NULL:
				...
				if (_la==K_NOT) {
					{
					setState(1040); match(K_NOT);
					}
				}

				setState(1043); match(K_NULL);
				setState(1044); conflict_clause();
				}
				break;
			case K_UNIQUE:
				{
				setState(1045); match(K_UNIQUE);
				setState(1046); conflict_clause();
				}
				break;
			case K_CHECK:
				{
				setState(1047); match(K_CHECK);
				setState(1048); match(OPEN_PAR);
				setState(1049); expr(0);
				setState(1050); match(CLOSE_PAR);
				}
				break;
			case K_DEFAULT:
				{
				setState(1052); match(K_DEFAULT);
				setState(1059);
				switch ( getInterpreter().adaptivePredict(_input,144,_ctx) ) {
				case 1:
					{
					setState(1053); signed_number();
					}
					break;
				case 2:
					{
					setState(1054); literal_value();
					}
					break;
				case 3:
					{
			...
			case K_COLLATE:
				{
				setState(1061); match(K_COLLATE);
				setState(1062); collation_name();
				}
				break;
			case K_REFERENCES:
				{
				setState(1063); foreign_key_clause();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Conflict_clauseContext conflict_clause() throws RecognitionException {
		...
		try {
			...
			if (_la==K_ON) {
				{
				setState(1066); match(K_ON);
				setState(1067); match(K_CONFLICT);
				setState(1068);
				_la = _input.LA(1);
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(1072); unary_operator();
				setState(1073); expr(21);
				}
				break;
			case 2:
				{
				setState(1075); literal_value();
				}
				break;
			case 3:
				{
				setState(1076); match(BIND_PARAMETER);
				}
				break;
			case 4:
				{
				...
				case 1:
					...
					case 1:
						{
						setState(1077); database_name();
						setState(1078); match(DOT);
						}
						break;
					}
					setState(1082); table_name();
					setState(1083); match(DOT);
					}
					break;
				}
				setState(1087); column_name();
				}
				break;
			case 5:
				{
				setState(1088); function_name();
				...
				case BLOB_LITERAL:
					...
					case 1:
						{
						setState(1090); match(K_DISTINCT);
						}
						break;
					}
			...
			case 7:
				{
				setState(1110); match(K_CAST);
				setState(1111); match(OPEN_PAR);
				setState(1112); expr(0);
				setState(1113); match(K_AS);
				setState(1114); type_name();
			...
			case 8:
				...
				if (_la==K_EXISTS || _la==K_NOT) {
					...
					if (_la==K_NOT) {
						{
						setState(1117); match(K_NOT);
						}
					}

					setState(1120); match(K_EXISTS);
					}
				}

				setState(1123); match(OPEN_PAR);
				setState(1124); select_stmt();
				setState(1125); match(CLOSE_PAR);
				}
				break;
			case 9:
				{
				setState(1127); match(K_CASE);
				setState(1129);
				...
				do {
					{
					{
					setState(1131); match(K_WHEN);
					setState(1132); expr(0);
					setState(1133); match(K_THEN);
					setState(1134); expr(0);
					}
					}
					setState(1138); 
					_errHandler.sync(this);
				...
				if (_la==K_ELSE) {
					{
					setState(1140); match(K_ELSE);
					setState(1141); expr(0);
					}
				}

				setState(1144); match(K_END);
				}
				break;
			case 10:
				{
				setState(1146); raise_function();
				}
				break;
			}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(1150); match(PIPE2);
						setState(1151); expr(21);
						}
						break;
					case 2:
						{
					...
					case 7:
						...
						setState(1168); match(K_AND);
						setState(1169); expr(14);
						}
						break;
					case 8:
						{
						...
						setState(1171); match(K_OR);
						setState(1172); expr(13);
						}
						break;
					case 9:
						{
						...
						setState(1174); match(K_IS);
						setState(1176);
						switch ( getInterpreter().adaptivePredict(_input,158,_ctx) ) {
						case 1:
							{
							setState(1175); match(K_NOT);
							}
							break;
						}
						setState(1178); expr(6);
						}
						break;
					case 10:
						{
						...
						if (_la==K_NOT) {
							{
							setState(1180); match(K_NOT);
							}
						}

						setState(1183); match(K_BETWEEN);
						setState(1184); expr(0);
						setState(1185); match(K_AND);
						setState(1186); expr(5);
						}
						break;
					case 11:
						{
						...
						if (_la==K_NOT) {
							{
							setState(1189); match(K_NOT);
							}
						}

						setState(1192); match(K_IN);
						setState(1212);
						switch ( getInterpreter().adaptivePredict(_input,164,_ctx) ) {
						case 1:
							{
							setState(1193); match(OPEN_PAR);
							setState(1203);
							switch ( getInterpreter().adaptivePredict(_input,162,_ctx) ) {
							case 1:
								{
								setState(1194); select_stmt();
								}
								break;
							case 2:
								{
								setState(1195); expr(0);
								setState(1200);
								_errHandler.sync(this);
								_la = _input.LA(1);
								while (_la==COMMA) {
						...
						case 2:
							...
							case 1:
								{
								setState(1206); database_name();
								setState(1207); match(DOT);
								}
								break;
							}
							setState(1211); table_name();
							}
							break;
						}
						}
					...
					case 12:
						...
						setState(1215); match(K_COLLATE);
						setState(1216); collation_name();
						}
						break;
					case 13:
						{
						...
						case 1:
							{
							setState(1223); match(K_ESCAPE);
							setState(1224); expr(0);
							}
							break;
						}
						}
					...
					case 14:
						...
						case K_ISNULL:
							{
							setState(1228); match(K_ISNULL);
							}
							break;
						case K_NOTNULL:
							{
							setState(1229); match(K_NOTNULL);
							}
							break;
						case K_NOT:
							{
							setState(1230); match(K_NOT);
							setState(1231); match(K_NULL);
							}
							break;
						default:
							throw new NoViableAltException(this);
	...
	public final Foreign_key_clauseContext foreign_key_clause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1239); match(K_REFERENCES);
			setState(1240); foreign_table();
			setState(1252);
			_la = _input.LA(1);
			if (_la==OPEN_PAR) {
				{
				setState(1241); match(OPEN_PAR);
			...
			while (_la==K_MATCH || _la==K_ON) {
				...
				case K_ON:
					...
					case 1:
						{
						setState(1256); match(K_SET);
						setState(1257); match(K_NULL);
						}
						break;
					case 2:
						{
						setState(1258); match(K_SET);
						setState(1259); match(K_DEFAULT);
						}
						break;
					case 3:
						{
						setState(1260); match(K_CASCADE);
						}
						break;
					case 4:
						{
						setState(1261); match(K_RESTRICT);
						}
						break;
					case 5:
						{
						setState(1262); match(K_NO);
						setState(1263); match(K_ACTION);
						}
						break;
					}
					}
			...
			case 1:
				...
				if (_la==K_NOT) {
					{
					setState(1275); match(K_NOT);
					}
				}

				setState(1278); match(K_DEFERRABLE);
				setState(1283);
				switch ( getInterpreter().adaptivePredict(_input,176,_ctx) ) {
				case 1:
					{
					setState(1279); match(K_INITIALLY);
					setState(1280); match(K_DEFERRED);
					}
					break;
				case 2:
					{
					setState(1281); match(K_INITIALLY);
					setState(1282); match(K_IMMEDIATE);
					}
					break;
				}
				}
	...
	public final Raise_functionContext raise_function() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1287); match(K_RAISE);
			setState(1288); match(OPEN_PAR);
			setState(1293);
			switch (_input.LA(1)) {
			case K_IGNORE:
				{
				setState(1289); match(K_IGNORE);
				}
				break;
			case K_ABORT:
			case K_FAIL:
			case K_ROLLBACK:
				...
				setState(1292); error_message();
				}
				break;
			default:
				throw new NoViableAltException(this);
			}
			setState(1295); match(CLOSE_PAR);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Indexed_columnContext indexed_column() throws RecognitionException {
		...
		try {
			...
			if (_la==K_COLLATE) {
				{
				setState(1298); match(K_COLLATE);
				setState(1299); collation_name();
				}
			}
	...
	public final Table_constraintContext table_constraint() throws RecognitionException {
		...
		try {
			...
			if (_la==K_CONSTRAINT) {
				{
				setState(1305); match(K_CONSTRAINT);
				setState(1306); name();
				}
			}
			...
			case K_UNIQUE:
				...
				case K_PRIMARY:
					{
					setState(1309); match(K_PRIMARY);
					setState(1310); match(K_KEY);
					}
					break;
				case K_UNIQUE:
					{
					setState(1311); match(K_UNIQUE);
					}
					break;
				default:
					throw new NoViableAltException(this);
				}
				setState(1314); match(OPEN_PAR);
				setState(1315); indexed_column();
				setState(1320);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
				...
				setState(1323); match(CLOSE_PAR);
				setState(1324); conflict_clause();
				}
				break;
			case K_CHECK:
				{
				setState(1326); match(K_CHECK);
				setState(1327); match(OPEN_PAR);
				setState(1328); expr(0);
				setState(1329); match(CLOSE_PAR);
				}
				break;
			case K_FOREIGN:
				{
				setState(1331); match(K_FOREIGN);
				setState(1332); match(K_KEY);
				setState(1333); match(OPEN_PAR);
				setState(1334); column_name();
				setState(1339);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
				...
				setState(1342); match(CLOSE_PAR);
				setState(1343); foreign_key_clause();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final With_clauseContext with_clause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1347); match(K_WITH);
			setState(1349);
			switch ( getInterpreter().adaptivePredict(_input,186,_ctx) ) {
			case 1:
				{
				setState(1348); match(K_RECURSIVE);
				}
				break;
			}
			setState(1351); common_table_expression();
			setState(1356);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
				...
				setState(1353); common_table_expression();
				}
				}
				setState(1358);
				_errHandler.sync(this);
	...
	public final Qualified_table_nameContext qualified_table_name() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(1359); database_name();
				setState(1360); match(DOT);
				}
				break;
			}
			setState(1364); table_name();
			setState(1370);
			switch (_input.LA(1)) {
			case K_INDEXED:
				{
				setState(1365); match(K_INDEXED);
				setState(1366); match(K_BY);
				setState(1367); index_name();
				}
				break;
			case K_NOT:
				{
				setState(1368); match(K_NOT);
				setState(1369); match(K_INDEXED);
				}
				break;
			case EOF:
			case SCOL:
	...
	public final Ordering_termContext ordering_term() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1372); expr(0);
			setState(1375);
			_la = _input.LA(1);
			if (_la==K_COLLATE) {
				{
				setState(1373); match(K_COLLATE);
				setState(1374); collation_name();
				}
			}
	...
	public final Pragma_valueContext pragma_value() throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				{
				setState(1382); match(STRING_LITERAL);
				}
				break;
			}
		}
	...
	public final Common_table_expressionContext common_table_expression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1385); table_name();
			setState(1397);
			_la = _input.LA(1);
			if (_la==OPEN_PAR) {
				{
				setState(1386); match(OPEN_PAR);
				setState(1387); column_name();
				setState(1392);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
				...
				setState(1395); match(CLOSE_PAR);
				}
			}

			setState(1399); match(K_AS);
			setState(1400); match(OPEN_PAR);
			setState(1401); select_stmt();
			setState(1402); match(CLOSE_PAR);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Table_or_subqueryContext table_or_subquery() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				case 1:
					{
					setState(1418); schema_name();
					setState(1419); match(DOT);
					}
					break;
				}
				setState(1423); table_name();
				setState(1428);
				_la = _input.LA(1);
				if (_la==OPEN_PAR || _la==K_AS || _la==IDENTIFIER || _la==STRING_LITERAL) {
					...
					if (_la==K_AS) {
						{
						setState(1424); match(K_AS);
						}
					}

					setState(1427); table_alias();
					}
				}
				...
				case K_INDEXED:
					{
					setState(1430); match(K_INDEXED);
					setState(1431); match(K_BY);
					setState(1432); index_name();
					}
					break;
				case K_NOT:
					{
					setState(1433); match(K_NOT);
					setState(1434); match(K_INDEXED);
					}
					break;
				case EOF:
				case SCOL:
			...
			case 2:
				...
				case 1:
					{
					setState(1437); schema_name();
					setState(1438); match(DOT);
					}
					break;
				}
				setState(1442); table_function_name();
				setState(1443); match(OPEN_PAR);
				setState(1452);
				_la = _input.LA(1);
				...
				if (_la==OPEN_PAR || _la==K_AS || _la==IDENTIFIER || _la==STRING_LITERAL) {
					...
					if (_la==K_AS) {
						{
						setState(1455); match(K_AS);
						}
					}

					setState(1458); table_alias();
					}
				}
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(1461); match(OPEN_PAR);
				setState(1471);
				switch ( getInterpreter().adaptivePredict(_input,208,_ctx) ) {
				case 1:
					{
					setState(1462); table_or_subquery();
					setState(1467);
					_errHandler.sync(this);
					_la = _input.LA(1);
					while (_la==COMMA) {
						...
						setState(1464); table_or_subquery();
						}
						}
						setState(1469);
						_errHandler.sync(this);
			...
			case 4:
				...
				setState(1476); select_stmt();
				setState(1477); match(CLOSE_PAR);
				setState(1482);
				_la = _input.LA(1);
				if (_la==OPEN_PAR || _la==K_AS || _la==IDENTIFIER || _la==STRING_LITERAL) {
					{
					...
					if (_la==K_AS) {
						{
						setState(1478); match(K_AS);
						}
					}

					setState(1481); table_alias();
					}
				}
	...
	public final Join_clauseContext join_clause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1486); table_or_subquery();
			setState(1493);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA || _la==K_CROSS || ((((_la - 87)) & ~0x3f) == 0 && ((1L << (_la - 87)) & ((1L << (K_INNER - 87)) | (1L << (K_JOIN - 87)) | (1L << (K_LEFT - 87)) | (1L << (K_NATURAL - 87)))) != 0)) {
				{
				{
				setState(1487); join_operator();
				setState(1488); table_or_subquery();
				setState(1489); join_constraint();
				}
				}
				setState(1495);
				_errHandler.sync(this);
	...
	public final Join_operatorContext join_operator() throws RecognitionException {
		...
		try {
			...
			case K_NATURAL:
				...
				case K_LEFT:
					{
					setState(1500); match(K_LEFT);
					setState(1502);
					_la = _input.LA(1);
					if (_la==K_OUTER) {
						{
						setState(1501); match(K_OUTER);
						}
					}
				...
				case K_INNER:
					{
					setState(1504); match(K_INNER);
					}
					break;
				case K_CROSS:
					{
					setState(1505); match(K_CROSS);
					}
					break;
				case K_JOIN:
					break;
	...
	public final Join_constraintContext join_constraint() throws RecognitionException {
		...
		try {
			...
			case K_ON:
				{
				setState(1511); match(K_ON);
				setState(1512); expr(0);
				}
				break;
			case K_USING:
				{
				setState(1513); match(K_USING);
				setState(1514); match(OPEN_PAR);
				...
				while (_la==COMMA) {
					{
					{
					setState(1516); match(COMMA);
					setState(1517); column_name();
					}
					}
					setState(1522);
					_errHandler.sync(this);
	...
	public final Select_coreContext select_core() throws RecognitionException {
		...
		try {
			...
			case K_SELECT:
				...
				if (_la==K_FROM) {
					{
					setState(1539); match(K_FROM);
					setState(1549);
					switch ( getInterpreter().adaptivePredict(_input,222,_ctx) ) {
					case 1:
						{
						setState(1540); table_or_subquery();
						setState(1545);
						_errHandler.sync(this);
						_la = _input.LA(1);
						while (_la==COMMA) {
							...
							setState(1542); table_or_subquery();
							}
							}
							setState(1547);
							_errHandler.sync(this);
				...
				if (_la==K_GROUP) {
					{
					setState(1557); match(K_GROUP);
					setState(1558); match(K_BY);
			...
			case K_VALUES:
				enterOuterAlt(_localctx, 2);
				{
				setState(1573); match(K_VALUES);
				setState(1574); match(OPEN_PAR);
				...
				while (_la==COMMA) {
					...
					setState(1585); match(OPEN_PAR);
					setState(1586); expr(0);
					setState(1591);
					_errHandler.sync(this);
					_la = _input.LA(1);
					while (_la==COMMA) {
	...
	public final Compound_operatorContext compound_operator() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(1603); match(K_UNION);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1604); match(K_UNION);
				setState(1605); match(K_ALL);
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(1606); match(K_INTERSECT);
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(1607); match(K_EXCEPT);
				}
				break;
			}
		}
	...
	public final Signed_numberContext signed_number() throws RecognitionException {
		...
		try {
			...
			setState(1613); match(NUMERIC_LITERAL);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Error_messageContext error_message() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1619); match(STRING_LITERAL);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Table_aliasContext table_alias() throws RecognitionException {
		...
		try {
			...
			case IDENTIFIER:
				enterOuterAlt(_localctx, 1);
				{
				setState(1663); match(IDENTIFIER);
				}
				break;
			case STRING_LITERAL:
				enterOuterAlt(_localctx, 2);
				{
				setState(1664); match(STRING_LITERAL);
				}
				break;
			case OPEN_PAR:
				enterOuterAlt(_localctx, 3);
				{
				setState(1665); match(OPEN_PAR);
				setState(1666); table_alias();
				setState(1667); match(CLOSE_PAR);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Any_nameContext any_name() throws RecognitionException {
		...
		try {
			...
			case IDENTIFIER:
				enterOuterAlt(_localctx, 1);
				{
				setState(1673); match(IDENTIFIER);
				}
				break;
			case K_ABORT:
			case K_ACTION:
			...
			case K_WITHOUT:
				enterOuterAlt(_localctx, 2);
				{
				setState(1674); keyword();
				}
				break;
			case STRING_LITERAL:
				enterOuterAlt(_localctx, 3);
				{
				setState(1675); match(STRING_LITERAL);
				}
				break;
			case OPEN_PAR:
				enterOuterAlt(_localctx, 4);
				{
				setState(1676); match(OPEN_PAR);
				setState(1677); any_name();
				setState(1678); match(CLOSE_PAR);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public static final String _serializedATN =
		...
		"\3\2\2\2\u042f\u0430\3\2\2\2\u0430O\3\2\2\2\u0431\u0432\b)\1\2\u0432\u0433"+
		"\5v<\2\u0433\u0434\5P)\27\u0434\u047e\3\2\2\2\u0435\u047e\5t;\2\u0436"+
		"\u047e\7\u0099\2\2\u0437\u0438\5\u0084C\2\u0438\u0439\7\4\2\2\u0439\u043b"+
		"\3\2\2\2\u043a\u0437\3\2\2\2\u043a\u043b\3\2\2\2\u043b\u043c\3\2\2\2\u043c"+
		"\u043d\5\u008aF\2\u043d\u043e\7\4\2\2\u043e\u0440\3\2\2\2\u043f\u043a"+
		"\3\2\2\2\u043f\u0440\3\2\2\2\u0440\u0441\3\2\2\2\u0441\u047e\5\u0090I"+
		"\2\u0442\u0443\5\u0082B\2\u0443\u0450\7\5\2\2\u0444\u0446\7@\2\2\u0445"+
		...
		"\u0431\3\2\2\2\u047d\u0435\3\2\2\2\u047d\u0436\3\2\2\2\u047d\u043f\3\2"+
